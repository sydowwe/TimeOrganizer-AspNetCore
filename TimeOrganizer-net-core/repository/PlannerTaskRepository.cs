...
{
    Task<IEnumerable<PlannerTask>> getAllByDateAndHourSpan(int userId, DateTime startDate, DateTime endDate);
}
...
{
    public async Task<IEnumerable<PlannerTask>> getAllByDateAndHourSpan(int userId, DateTime startDate, DateTime endDate)
    {
